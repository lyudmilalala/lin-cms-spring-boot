...
public class ResponseUtil {
    ...
    public static PageResponseVO generatePageResult(int total, List items, int page, int count, int pages) {
        return new PageResponseVO(total, items, page, count, pages);
    }
}
